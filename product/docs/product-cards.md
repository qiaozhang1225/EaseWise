...
- `knowledge/sections/board_description/judgement-knowledge.md`
- `knowledge/sections/board_description/taxonomy.md`
- `knowledge/shared/model-baseline.md`
- `scoring/engine.py`
- `scoring/payloads/board_description.py`
...
- 核心链路并发优先保障，后台专项预热让路
- 单用户专项并发保持可配置，例如 `EASEWISE_ASPECT_V2_WORKERS=4-8`

...
router.add_api_route("/reviews/stream", handlers.stream_create_four_pillars_review_record, methods=["POST"])
...
router.add_api_route("/reviews/{review_id}/aspect-unlocks/{aspect_key}/stream", handlers.stream_four_pillars_review_aspect_unlock_record, methods=["POST"])
...
router.add_api_route("/reviews/{review_id}/luck-cycles/{cycle_key}/summary/stream", handlers.stream_four_pillars_luck_cycle_summary, methods=["POST"])
...
router.add_api_route("/reviews/{review_id}/luck-cycles/{cycle_key}/years/{year}/stream", handlers.stream_four_pillars_luck_year_summary, methods=["POST"])

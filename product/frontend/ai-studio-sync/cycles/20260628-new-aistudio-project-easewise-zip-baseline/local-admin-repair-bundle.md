# EaseWise Local Admin Appendix Bundle For New AI Studio Project
## Usage
This appendix contains the very large local admin workspace file. Use it only if the new AI Studio project must also preserve admin parity. Keep it separate from the H5 bundle to avoid overwhelming the initial repair prompt.
## Manifest
- `src/components/admin/AdminWorkspace.vue` (348028 bytes)

Total source bytes: `348028`

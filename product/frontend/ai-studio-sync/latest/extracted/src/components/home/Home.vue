...
<template>
  <div class="pt-4 pb-32 max-w-md mx-auto px-margin-mobile relative">
    ...
    <section class="mb-4">
      ...
      >
        <div class="absolute top-0 right-0 bg-brand-accent text-brand-ink-strong font-sans text-[10px] font-bold px-3 py-1 rounded-bl-xl uppercase tracking-wide">
          奇门遁甲 · 智能推演
        </div>
        <div class="flex flex-col gap-1.5 z-10 max-w-[70%]">
          ...
          <span class="font-sans text-[13px] text-white/80 leading-relaxed">
            输入你的 11 位手机号，解锁智能推演下的 13 项全面评测结果。
          </span>
          <div class="flex items-center gap-3 mt-1.5 flex-wrap">
            <span class="font-sans text-[11px] text-brand-accent font-bold">
              数字奇门手机号评测 →
            </span>
            <span class="px-2.5 py-1 bg-brand-accent/20 border border-brand-accent/40 rounded-lg font-sans text-[10px] font-bold text-brand-accent leading-none select-none shadow-sm">
      ...
      >
        ...
        <div class="flex flex-col gap-1.5 z-10 max-w-[70%]">
          ...
          <span class="font-sans text-[13px] text-brand-secondary leading-relaxed">
            输入出生日期 and 时辰，查看命盘结构、五行比例、日主和专项趋势。
          </span>
          <div class="flex items-center gap-3 mt-1.5 flex-wrap">
